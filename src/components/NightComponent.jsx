...
export default function NightComponent() {
  ...
  function getHeartPosition(index, total) {
    ...
    // Invertimos la coordenada y para que se alinee con la pantalla
    return { x, y: -y }
  }
  ...
  return (
    <div className={styles["motivational-container"]}>
      ...
      {/* Estrellas fugaces */}
      <div className={styles["shooting-stars"]}>
        {[...Array(5)].map((_, i) => (
          <div
            key={i}
      ...
      {showHeart && (
        <div className={styles["heart-section"]}>
          ...
          <motion.div className={styles["heart-drawing-container"]}>
            <svg width="600" height="600" viewBox="-300 -300 600 600" className={styles["heart-svg"]}>
              <defs>
                <filter id="glow">
